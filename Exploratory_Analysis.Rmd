...
### **3. Proportion of Individuals Below Poverty Level vs Vaccination and Booster Coverage**
...
joined_dataset_poverty %>% 
  ...
  labs(
   title = "Fully Vaccinated Individuals Below Poverty Level (Aged 18+)", 
    ...
    y = "Proportion of Individuals Below Poverty level (Aged 18+)")
...
joined_dataset_poverty %>% 
  ...
  labs(
   title = "Additional/Booster Vaccinated Individuals Below Poverty Level (Aged 18+)", 
    ...
    y = "Proportion of Individuals Below Poverty Status (Aged 18+)")
